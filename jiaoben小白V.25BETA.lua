...
--脚本UI基于图书馆
game:GetService("StarterGui"):SetCore("SendNotification",{                Title = "GITHUB";                Text ="xiaobai加载";                Duration = 6;            })
...
Tab:AddButton({
	Name = "连接白脚本",
	Callback = function()
	loadstring(game:HttpGet(('https://pastebin.com/raw/Nq9hVX6n'),true))()
  	end
})
